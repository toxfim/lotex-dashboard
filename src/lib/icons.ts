export const ICON_PATHS: Record<string, string> = {
  ...
  inbox: '<path d="M22 12h-6l-2 3h-4l-2-3H2"/><path d="M5.5 5.5 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.5-6.5A2 2 0 0 0 16.8 4H7.2a2 2 0 0 0-1.7 1.5"/>',
  ...
  vector: '<circle cx="6" cy="6" r="2.5"/><circle cx="18" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="18" r="2.5"/><path d="M8.5 6h7M6 8.5v7M18 8.5v7M8.5 18h7M8 8l8 8"/>',
  ...
  coins: '<ellipse cx="9" cy="6" rx="6" ry="3"/><path d="M3 6v6c0 1.7 2.7 3 6 3s6-1.3 6-3"/><path d="M15 9.5c2.5.4 6 1.6 6 3.5 0 1.7-2.7 3-6 3"/><path d="M3 12v6c0 1.7 2.7 3 6 3 1.5 0 2.9-.3 4-.7"/>',
  scale: '<path d="M12 3v18M7 21h10M5 7l-3 7a3 3 0 0 0 6 0L5 7Zm14 0-3 7a3 3 0 0 0 6 0l-3-7ZM5 7h14M12 3 5 7M12 3l7 4"/>',
